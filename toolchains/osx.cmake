...
SET(BREW_LIB_DIR "${BREW_DIR}/lib")
SET(BREW_INC_DIR "${BREW_DIR}/include")

SET(DOWNLOAD ON)
INCLUDE_DIRECTORIES(${PROJECT_BINARY_DIR}/contrib/include)
INCLUDE_DIRECTORIES(${BREW_INC_DIR})
...
SET(OPENSSL_ROOT_DIR "${BREW_LIB_DIR}/openssl")
...
SET(LIBS ${LIBS} -L${LIB_DIR} -L${BREW_LIB_DIR} -lavcodec -lavformat -lswscale -lavutil)
